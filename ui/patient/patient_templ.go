...
func Alert() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"w-screen h-screen bg-rose-200 flex flex-col p-8 items-center justify-center\"><div class=\" w-full rounded-lg relative\"><div class=\"left-0 top-[-16px] text-white text-2xl w-full h-fit bg-red-700 px-8 py-2 border-b-4 border-white font-medium text-center\">Alert</div><div class=\"w-full flex flex-col gap-4 py-[1.5rem] px-8 items-center\"><div><img class=\"h-40 pb-8 border-b border-red-700\" src=\"/assets/img/warning-sign.svg\"></div><p class=\"text-center text-2xl\">Your recent blood test results have come back <span class=\"font-bold\">abnormal.</span></p><p class=\"text-center text-2xl\"><span class=\"font-bold underline text-red-600\">DO NOT</span> take the next dose of Methotrexate and call your GP as soon as possible.</p></div></div><div class=\"flex w-full gap-4\"><a href=\"/patient?ack=true\" hx-push-url=\"false\" type=\"button\" class=\"flex flex-auto gap-4 items-center justify-center px-4 py-2 rounded-md w-fit bg-nhs-grey-3 text-white\"><div class=\"font-medium tracking-wide text-lg\">Acknowledge</div></a> <button class=\"flex flex-auto gap-2 items-center justify-center px-4 py-2 rounded-md w-fit bg-nhs-green-2 text-white\"><img class=\"h-6\" src=\"/assets/img/phone.svg\"><div class=\"font-medium tracking-wide text-lg\">Call GP</div></button></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
...
func Appointment() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"h-screen\"><div class=\"w-screen bg-nhs-yellow-1 flex flex-col pt-24 px-16 pb-8 items-center justify-center\"><div class=\"w-full relative border border-b-[4px] border-nhs-grey-3\"><div class=\"absolute left-[13px] top-[-48px] text-white text-xl text-center w-[219px] bg-nhs-blue-1 px-2 py-2 border-b-4 border-white font-medium\">Appointment Reminder</div><div class=\"w-full flex flex-col gap-4 py-[1.5rem] px-8 items-center justify-center\"><div><img class=\"h-40 mt-4 pb-6 border-b border-grey-700 gap-2\" src=\"/assets/img/calendar.svg\"></div><p class=\"text-center text-lg\">Your next blood test is due on <span class=\"font-bold\">17/1/24</span>.</p><p class=\"text-center text-lg\">Please call <span class=\"underline text-blue-500\">0123456789</span> to book an appointment with your GP.</p></div></div></div><div class=\"flex gap-4 p-8 pt-2\"><a href=\"/patient?ack=true\" type=\"button\" class=\"flex flex-auto gap-4 items-center justify-center px-4 py-2 rounded-md w-fit bg-nhs-grey-3 text-white\"><div class=\"font-medium tracking-wide text-lg\">Acknowledge</div></a> <button class=\"flex flex-auto gap-2 items-center justify-center px-4 py-2 rounded-md w-fit bg-nhs-blue-1 text-white\"><img class=\"h-6\" src=\"/assets/img/phone.svg\"><div class=\"font-medium tracking-wide text-lg\">Call GP</div></button></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
